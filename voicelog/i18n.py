...
STRINGS = {
    "zh": {
        ...
        "model_get": "⬇ 下载语音模型（必需）", "model_check": "语音模型：已就绪 ✓",
        "model_dling": "下载模型 {p}%…", "model_done": "语音模型已就绪，现在可以开始用了。",
        "model_fail_t": "模型下载失败",
    ...
    "en": {
        ...
        "model_get": "⬇ Download speech model (required)", "model_check": "Speech model: ready ✓",
    ...
    "ja": {
        ...
        "model_get": "⬇ 音声モデルをダウンロード（必須）", "model_check": "音声モデル：準備完了 ✓",
